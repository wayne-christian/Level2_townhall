...
Reveal.addEventListener('salarycs', function () {
...
Reveal.addEventListener('jobscs', function () {
	console.log('stats called!');
	animatenum(14950, '#jobscs', 0);
});
Reveal.addEventListener('jobsgc', function () {
	console.log('stats called!');
	animatenum(10660, '#jobsgc', 0);
	
});

Reveal.addEventListener('salarygc', function () {
	console.log('stats called!');
	animatenum(399, '#decimalsgc', 0);
});
Reveal.addEventListener('guagecs', function () {
	console.log('guags called!');
	guage(0, 60000, 49880, "£49,880","container-speedcs");
});
Reveal.addEventListener('guagegc', function () {
	console.log('guags called!');
